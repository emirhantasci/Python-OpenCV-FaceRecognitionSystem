...
recognizer.read('C:/Users/emirh/Desktop/emirhan/yazılım/robotik/egitim/training/trainer.yml')
cascadePath = "face.xml"
faceCascade = cv2.CascadeClassifier(cascadePath)
path = 'C:/Users/emirh/Desktop/emirhan/yazılım/robotik/egitim/yuzverileri'
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if(tahminEdilenKisi==2):
             tahminEdilenKisi= 'Emirhan Taşçı'
